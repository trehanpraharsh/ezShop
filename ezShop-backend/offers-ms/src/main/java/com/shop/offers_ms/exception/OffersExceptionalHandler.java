...
public class OffersExceptionalHandler {
    ...
    //! Test this way of handling exceptions, like returning a map of errors with response entity - WORKS
    ...
    //*For OfferNotFoundException (custom exception)
